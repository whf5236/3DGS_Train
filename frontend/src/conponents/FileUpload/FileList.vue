            ...
            <template #default="{ row }">
              <div class="file-name-cell">
                ...
                <el-tag 
                  ...
                  size="small" 
                  :type="getFolderStageTagType(row.category)"
                >
                  {{ getFolderStageLabel(row.category) }}
                </el-tag>
                <el-tag 
                  v-else 
                  size="small" 
...
import { Folder, FolderOpened, Picture, Refresh,
  Search, Grid, List, SortUp, SortDown,
  Histogram, Delete, DataAnalysis, Connection,
} from '@element-plus/icons-vue'
import { ElTableColumn,ElTable,ElButton,ElTag,
  ElEmpty,ElIcon,ElResult,ElSkeleton,ElButtonGroup,
  ElSelect,ElOption,ElInput } from 'element-plus'

import { useFileListComponent, } from '@/composables/useUpload/useFileList'
import { type FolderItem } from '@/stores/fileStore'
import { useCommon } from '@/composables/useUpload/common'
import FileCard from './components/FileCard.vue'
import FileIcon from './components/FileIcon.vue'
const { formatFileSize, formatDate } = useCommon()
