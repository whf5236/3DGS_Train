...
import type { ModelLoadRequest } from './model-load-request';

let assetId = 0;

const loadPly = (assets: any, loadRequest: ModelLoadRequest) => {
    ...
    return new Promise<any>((resolve, reject) => {
        ...
        asset.on('load', () => {
            ...
            const splatData = (asset.resource as any).gsplatData as GSplatData;
